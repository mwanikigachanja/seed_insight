...
data = {
    ...
    'Availability': ['Available', 'Available', 'Available', 'Available', 'Available', 'Available', 'Available', 'Available', 'Available', 'Available', 'Available']
}
...
filtered_data = df[(df['Variety'] == variety) & (df['Ecozone'] == ecozone) & (df['Price (Ksh)'] >= price_range[0]) & (df['Price (Ksh)'] <= price_range[1])]
